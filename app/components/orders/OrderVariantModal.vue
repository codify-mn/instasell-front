            ...
            <UCard class="w-full max-w-lg">
                ...
                <div class="space-y-3 max-h-96 overflow-y-auto">
                    ...
                    >
                        <!-- Variant Image -->
                        <div
                            class="w-14 h-14 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center overflow-hidden shrink-0"
                        >
                            <img
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="font-medium text-(--text-heading) truncate">
                                {{ variant.name }}
                            </p>
                            ...
                            >
                                {{
                                    isOutOfStock(variant)
                                        ? 'Дууссан'
                                        : `${variant.stock_quantity}ш үлдсэн`
                                }}
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                            ...
                            <input
                                ...
                                class="w-12 h-8 text-center text-sm border border-gray-200 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-(--text-heading)"
                                @input="
                                    setQuantity(
                                        variant.id,
                            ...
                            <UButton
                                ...
                                :disabled="
                                    isOutOfStock(variant) ||
                                    getQuantity(variant.id) >= variant.stock_quantity
                                "
                    ...
                    <div v-if="!product?.variants?.length" class="text-center py-8 text-gray-500">
                        Төрөл олдсонгүй
                    </div>
                </div>
