...
<template>
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <label class="text-sm font-medium text-(--text-body)">Банкны данс</label>
        ...
        >
            <UIcon name="i-lucide-credit-card" class="w-8 h-8 text-(--text-placeholder) mx-auto mb-2" />
            <p class="text-sm text-(--text-muted)">Банкны данс оруулна уу</p>
